...
- Current role: Admissions Assistant at the University of New Haven — detail-oriented, tech-savvy, and experienced with Slate CRM, data processing, and student support.
- Summary: Information science professional with experience in software development, secure coding, data analysis, and project work. Strong at problem-solving, teamwork, and clear communication.
- Location: New Haven, Connecticut
- Education: Master’s in Information Science — University of New Haven; Bachelor’s in Electronics and Communication Engineering — UIET

---

## Skills & Tools

- Software Development • Full-Stack Projects • Secure Coding
- Data Analysis • SQL • Database Design
- Research • Technical Writing • Project Management
- Cross-functional Collaboration • Problem Solving • Communication
- Tools: Python • Java • C • SQL • Git • GitHub • Slate CRM • VS Code • IntelliJ • MySQL • Linux • Figma
